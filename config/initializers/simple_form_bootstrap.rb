...
SimpleForm.setup do |config|
  ...
  config.wrappers :icheck_boolean, tag: 'div', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.optional :icheck
    b.wrapper :icheck_wrapper, tag: 'div', class: "icheck" do |bb|
      bb.use :input, class: 'check-input', error_class: 'is-invalid', valid_class: 'is-valid'
      bb.use :label, class: 'check-label'
      bb.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback' }
      bb.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
    end
  end

  config.wrappers :icheck_collection, item_wrapper_class: 'form-check icheck-primary', item_label_class: '', tag: 'div', class: 'form-group row' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'col-sm-3 col-form-label pt-0'
    b.wrapper :grid_wrapper, tag: 'div', class: 'col-sm-9' do |ba|
  ...
  # horizontal input for inline radio buttons and check boxes
  config.wrappers :icheck_collection_inline, item_wrapper_class: 'form-check form-check-inline icheck-primary', item_label_class: 'form-check-label', tag: 'div', class: 'form-group row' do |b|
    b.use :html5
    b.optional :readonly
    b.use :label, class: 'col-sm-3 col-form-label pt-0'
    b.wrapper :grid_wrapper, tag: 'div', class: 'col-sm-9' do |ba|
